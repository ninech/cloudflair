...
describe Cloudflair::MobileRedirect do
  ...
  let(:setting_identifier) { 'mobile_redirect' }
  let(:value) { { 'status' => 'off', 'mobile_subdomain' => 'm', 'strip_uri' => false } }
  let(:new_value) { { 'status' => 'on', 'mobile_subdomain' => 'i', 'strip_uri' => true } }
